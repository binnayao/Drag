...
export default class componentName extends Component {
  ...
  render() {
    ...
    return (
      <div
        style={{ width: max, margin: "0 auto", height: "100%" }}
        className="col"
      >
        <Example />
        ...
        <div style={{ width: max, overflow: "hidden" }} className="flex1">
          <div
            style={{ width: max * 5, marginLeft: this.state.left }}
        ...
        >
          ...
          <div
            onClick={this.next}
            style={{ background: "#75ca86" }}
            className="flex2 huobutton"
          >
            {this.state.index === 4 ? "生成测试结果" : "下一题"}
          </div>
        </div>
      </div>
    );
